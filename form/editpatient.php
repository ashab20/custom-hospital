                                ...
                                <div class="col-lg-12 mx-auto">
                                    ...
                                    <div class="wrapper bg-white py-5">
                                        ...
                                        <div class="row  mx-5">
                                            ...
                                            <div class="col-md-6 pt-md-0 pt-3 d-flex justify-content-end">
                                                <a class="btn btn-gradient-primar"
                                                    href="<?= $baseurl ?>/pages/profile.php?id=<?= $selectUser['singledata']['id']?>">Back
                                                    to Profile</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-start py-3 border-bottom justify-content-start">
                                            <img src="../assets/images/faces/face1.jpg" class="img rounded-circle mx-5"
                                                alt="" width="100px">
                                            ...
                                            <div>
                                                ...
                                                <div class="mt-4 d-none" id="fileUp">
                                                    <form class="pl-sm-4 pl-2" method="POST"
                                                        ...
                                                        <button type="submit" name="images_upload"
                                            ...
                                            <div class="form-row d-flex">
                                                <div class="form-group col-md-6 mx-2">
                                                    ...
                                                    <input type="text" name="phone"
                                                        value="<?=$selectUser['singledata']['phone'] ?>"
                                                        class="form-control" id="phone" placeholder="Phone">
                                                </div>
                                                <div class="form-group col-md-6 mx-2">
                                                    <label for="inputAddress">Address</label>
                                                    <input type="text" name="address"
                                                        value="<?=$selectUser['singledata']['address']?>"
                                                        class="form-control" id="inputAddress"
                                                        placeholder="1234 Main St">
                                                </div>
                                            </div>
