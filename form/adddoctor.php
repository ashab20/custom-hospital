                                                ...
                                                <div class="form-group col-md-2 mx-2">
                                                    ...
                                                    <select name="chamber_id" id="" class="form-control">
                                                        ...
                                                        <option value="<?=$room['id']?>">
                                                            <?= $room['room_type']?>-<?= $room['room_no']?></option>
                                                        <?php  }     ?>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-2 mx-2">
                                            ...
                                            <div class="form-row d-flex">
                                                ...
                                                <div class="form-group col-md-6 mx-2">
                                                    ...
                                                    <input type="text" name="father_name" class="form-control"
                                                        id="father" placeholder="Father's Name">
                                                </div>
                                                <div class="form-group col-md-6 mx-2">
                                                    <label for="mother">Mother's Name:</label>
                                                    <input type="text" name="mother_name" class="form-control"
                                                        id="mother" placeholder="Mother's Name">
                                                </div>
                                            </div>
                                            <div class="form-row d-flex">
                                                <div class="form-group col-md-4 mx-2">
                                                    <label for="gratuated">Gratuated From:</label>
                                                    <input type="text" name="gratuated_from" class="form-control"
                                                        id="gratuated" placeholder="College/University Name">
                                                </div>
                                                <div class="form-group col-md-4 mx-2">
                                                    <label for="qualify">Qualification:</label>
                                                    <input type="text" name="qualification" class="form-control"
                                                        id="qualify" placeholder="Qualification">
                                                </div>
                                                <div class="form-group col-md-4 mx-2">
                                                    <label for="inputAddress">Max Appointment</label>
                                                    <input type="text" class="form-control"
                                                        name="daily_approval_patient" placeholder="10">
                                                </div>
                                            </div>
                                            <div class="form-row d-flex">
                                                <div class="form-group col-md-3 mx-2">
                                                    <label for="date">Date Of Birth:</label>
                                                    <input type="date" max="<?= $date ?>" name="date_of_birth"
                                                        class="form-control" id="date" placeholder="Name">
                                                </div>
                                                <div class="form-group col-md-3 mx-2">
                                                ...
                                                <div class="form-group col-md-2 mx-2">
                                                    ...
                                                    <select name="department_id" class="form-control">
                                                        ...
                                                        <option id="deprtment" value="<?=$dept['id'] ?>">
                                                            <?= $dept['name']?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
