                    ...
                    <div class="col-12 ">
                      ...
                      ?>
                                ...
                                <div class="card bg-gradient-primary" style="width: 15rem;">
                                    <button class=" btn btn-sm font-weight-normal text-white" id="addPatientBtn"><i
                                            class="mdi mdi-alarm-plus   float-right"></i> Add New Patient
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="row card-body justify-content-center d-block" id="searchPatient">
                                <form class="form-inline d-flex w-80 col-8 offset-2" method="GET" name="search_patient">
                                    <input class="form-control mr-sm-2 fload-right" id="inputSearch" type="search"
                                        name="phn" placeholder="Search by phone" aria-label="Search">
                                    <button class="btn btn-outline-success my-2 my-sm-0" id="inputSubmit" disabled
                            ...
                            <div class="col-8 offset-2 my-2">
                                ...
                                <p class="mt-5 text-center h2 text-danger justify-content-center mx-auto">Data not found
                                </p>
                                <?php } ?>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <?php  
                                    if($ChechAmiitedStatus["numrows"] > 0){?>
                                            <td><label for=""><?= $ChechAmiitedStatus["singledata"]["roles"]?></label>
                                            </td>
                                            <?php }?>
                                        </tr>
                                    </tbody>
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-4 offset-4">
                                        <div class="card">
                                            ...
                                            <button class=" btn btn-sm btn-outline-dark font-weight-normal mb-3"
                                                id="appointmentBtn"><i class="mdi mdi-alarm-plus   float-right"></i>
                                                Appointment
                                            </button>
                        ...
                        <div class="card">
                          ...
                          foreach ($createdBy as $admin){?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn"
                                                        href="<?=$baseurl ?>/pages/profile.php?patientid=<?= $admin['id'] ?>">
                                                        <?= $admin['name']?>
                                                    </a>
                                                </td>
                                                <td><?= $admin['phone']?></td>
