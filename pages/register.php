                ...
                ?>
                        <form class="pt-3" method="POST" action="<?= $baseurl?>/form/auth.php">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-lg" required id="" name="name"
                                    placeholder="Full Name">
                            </div>
                            <div class="form-group">
                                <input type="email" name="email" required class="form-control form-control-lg" id=""
                                    placeholder="Email">
                            </div>
                            <div class="form-group">
                                <input type="text" name="phone" required class="form-control form-control-lg" id=""
                                    placeholder="Phone" minlength="10" maxlength="11">
                            </div>
                            ...
                            <div class="form-group">
                                <input type="password" name="cpassword" required class="form-control form-control-lg"
                                    id="cpassword" placeholder="Confirm Password" onchange="mathedPassword()">
