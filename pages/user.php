                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?=$baseurl ?>/form/adduser.php"
...
foreach ($user as $u){?>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="../assets/images/faces/face3.jpg" class="me-2"
                                                        alt="image">
                                                    <a class="btn"
                                                        href="<?=$baseurl ?>/pages/profile.php?id=<?= $u['id'] ?>">
                                                        <?= $u['name']?>
                                                    </a>
                                                </td>
                                                <td><?= $u['email']?></td>
                              ...
                              ?>
                                                ...
                                                <td>
                                                    <a href="<?= $baseurl ?>/form/updateuser.php?id=<?= $u['id'] ?>"
                                                        class="btn-sm btn-primary text-decoration-none m-1">
                                                        <i class="mdi mdi-border-color"></i>
                                                    </a>
                                                    <a href="<?= $baseurl ?>/form/deleteuser.php?id=<?= $u['id'] ?>"
                                                        class="btn-sm btn-danger text-decoration-none"
