      ...
      ?>
                ...
                <div class="wrapper bg-white py-5">
                    ...
                    <div class="d-flex align-items-start py-3 border-bottom justify-content-start mb-2 ">
                        ...
                        <img src="../assets/images/avatar/<?= $usr['avatar'] ?>" class="img rounded-circle mx-5" alt=""
                            width="100px" />
                        <?php }else{  ?>
                        <img src="../assets/images/faces-clipart/pic-4.png" class="img rounded-circle mx-5" alt=""
                            width="100px" />
                        <?php } ?>
                        <div>
                            ...
                            <div class="my-4 d-none" id="fileUp">
                                <form class="pl-sm-4 pl-2" method="POST" action="<?= $baseurl ?>/form/action.php"
                                    enctype="multipart/form-data" id="img-section">
                        ...
                        <div class="form-row ">
                            ...
                            <div class="row d-flex input-group py-2 justify-content-center">
                                <div class=" col-md-4 d-flex">
                                    ...
                                    <input type="text" readonly value="<?=$profile['roles']?>"
                                        class="form-control form-control bg-white" id="phone">
                                </div>
                                <div class="col-md-4 d-flex">
                                    <span class="input-group-text">Status:</span>
                                    <input type="text" readonly
                                        value="<?=$profile['status']== 0 ? 'DEACTIVE' : 'ACTIVE'?>"
                                        class="form-control bg-white form-control" id="phone">
                                </div>
                            </div>
                            <?php } ?>
                            <div class="row d-flex input-group py-2 justify-content-center">
                    ...
                    <div class="pt-3 justify-content-center items-center">
                            ...
                            <div class="wrapper mx-5">
                                ...
                                <div class="row">
                                    <div class=" col-10 offset-2 d-flex justify-content-between my-4 m-2">
                                        ...
                                        <span>
                                            <a href="<?= $baseurl ?>/form/updatedoctor.php?doctorid=<?=$user_Id?>"><i
                                                    class=" mdi mdi-border-color" style="cursor:pointer"></i></a>
                                            <i class=" mdi mdi-chevron-down" style="cursor:pointer"
                                                onclick="$('#doctorProfile').toggleClass('d-none')"></i>
                                        </span>
                                    </div>
                                    ...
                                    <div class="pt-3 justify-content-center items-center" id="doctorProfile">
                                        ...
                                        <div class="row d-flex input-group py-2 justify-content-center">
                                            <div class=" col-md-4 d-flex">
                                                ...
                                                <input type="text" readonly value="<?=$doctor['father_name']?>"
                                                    class="form-control form-control bg-white" id="phone">
                                            </div>
                                            <div class="col-md-4 d-flex">
                                                <span class="input-group-text">Mother name:</span>
                                                <input type="text" readonly value="<?=$doctor['mother_name']?>"
                                                    class="form-control bg-white form-control" id="phone">
                                            </div>
                                        </div>
                                        <div class="row d-flex input-group py-2 justify-content-center">
                                            <div class=" col-md-4 d-flex">
                                                ...
                                                <input type="text" value="<?=$doctor['gratuated_from']?>" readonly
                                                    class="form-control bg-white">
                                            </div>
                                            <div class=" col-md-4 d-flex">
                                                <span class="input-group-text">Qualification:</span>
                                                <input type="text" readonly value="<?=$doctor['qualification']?>"
                                                    class="form-control bg-white">
                                            </div>
                                        </div>
                                        <div class="row d-flex input-group py-2 justify-content-center">
                                            <div class=" col-md-4 d-flex">
                                                ...
                                                <input type="text" value="<?=$doctor['shift']?>" readonly
                                                    class="form-control bg-white">
                                            </div>
                                            <div class=" col-md-4 d-flex">
                                                <span class="input-group-text">Consulant Fees:</span>
                                                <input type="text" readonly class="form-control form-control bg-white"
                                                    value="<?= $doctor['visit_fee']?>tk">
                                            </div>
                                        </div>
                                        <div class="row d-flex input-group py-2 justify-content-center">
                                            <div class=" col-md-4 d-flex">
                      ...
                      ?>
                                            ...
                                            <div class=" col-md-4 d-flex">
                                                ...
                                                <input type="text" value="<?=$doctor['date_of_birth']?>" readonly
                                                    class="form-control bg-white">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 d-flex justify-content-between mt-4">
                                        ...
                                        <span>
                                            <i class=" mdi mdi-chevron-down pointer" style="cursor:pointer"
                                                onclick="$('#medical').toggleClass('d-none');"></i>
                                        </span>
                                    </div>
                                    <hr>
              ...
              foreach($dctappointment as $app){?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="d-flex justify-content-center">
                                                                <a title="Details"
                                                                    href="<?= $baseurl ?>/pages/profile.php?patientid=<?= $app['patient_id'] ?>"
                              ...
                              if($checkApp["numrows"] > 0){ ?>
                                                                ...
                                                                <a title="Prescription"
                                                                    href="<?= $baseurl ?>/pages/prescription.php?appointmentid=<?= $app['id'] ?>"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    <img src="../assets/images/icons/patient.png" class="img rounded-circle mx-5" alt=""
                                        width="100px" />
                                ...
                                <div class="col-md-8">
                                    <div class="row d-flex input-group py-2">
                                        ...
                                        <div class=" col-md-6 d-flex">
                                            <span class="input-group-text">Address:</span>
                                            <input type="text" value="<?= $patient['present_address']?>"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="row d-flex input-group py-2">
                                    ...
                                    <td>
                                        <span class="d-flex justify-content-center">
                                            <a title="Appointment Card" target="_blank"
                                                href="<?= $baseurl ?>/view/appointmentcard.php?aid=<?= $app['appointment_id'] ?>"
                                                class="btn-sm bg-primary text-white text-decoration-none m-1">
