...
?>
                ...
                <div class="row bg-info mx-4 py-4 d-grid justify-content-center d-none"
                    style="position:absolute;z-index:1000;opacity:1;width:50%;margin:0 auto;top:10rem;" id="payment">
                    <form class="pt-3 justify-content-center items-center" method="POST"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 mx-2">
                                <input type="text" readonly name="id" hidden value="<?= $invoiceId ?>"
                                    class="form-control bg-white" id="set_total" placeholder="Total">
                                <label for="name">Total:</label>
                                <input type="text" readonly name="total" value="<?= $invoice["total"] ?>"
                                    class="form-control bg-white" id="set_total" placeholder="Total">
                            </div>
                            <div class="form-group col-md-12 mx-2">
                                <label for="name">Due:</label>
                                <input type="text" readonly value="<?=$invoice["total"] - $invoice["payment"] ?>"
                                    class="form-control bg-white" id="set_due" placeholder="Total">
                            </div>
                            <div class="form-group col-md-12 mx-2">
                                <label for="rate">Payment:</label>
                                <input type="number" name="paid" required class="form-control" id="set_payment"
                                    placeholder="Payment">
                                <input type="number" name="payment" hidden value="<?=$invoice["payment"] ?>"
                                    class="form-control" id="set_payment" placeholder="Payment">
                            </div>
                        </div>
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary mx-2"
                                name="update_invoice_payment">Payment</button>
                            <button type="submit" class="btn btn-danger mx-2"
                                onclick="$('#payment').addClass('d-none');$('.page-content').removeClass('d-none')">Close</button>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="page-header text-blue-d2">
                        ...
                        <div class="page-tools">
                            <div class="action-buttons">
                                <button id="printer" class="btn bg-white btn-light mx-1px text-95" href="#"
                                    data-title="Print">
                    ...
                    <div class="container px-0" id="printPage">
                        ...
                        <div style="margin-top: 1rem;">
                            <div style="display:grid">
                                <div style="display: flex;justify-content:center;text-align:center;">
                                    <img src="../assets/images/hospital-sign.png" alt="img" width="40px"
                                        style="padding: .2rem;">
                                    <h2 style="color:#dd4949;font-weight: 700;"><strong>HOSPITA<span>L</span></strong>
                                    </h2>
                                ...
                                <div
                                    style="display: grid;grid-template-columns: repeat(auto-fit,minmax(40%,1fr));margin-top:.5rem">
                                    <div style="padding:.5rem;">
                                        <div>
                                            <span style="color:#615f5f;font-size:1.2rem;">Patient: </span>
                                            <span
                                                style="color:#478fcc;font-wight:500;font-size:1.2rem;"><?= $invoice['name']?></span>
                                        </div>
                                        <div style="color:gray">
                                            ...
                                            <div class="my-1">
                                                ...
                                                <b class="text-600"><?= $invoice['phone']?></b>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.col -->
                                        ...
                                        <div class="text-grey-m2">
                                            ...
                                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i>
                                                <span class="text-600 text-90">Status:</span> <span
                                                    class="badge badge-warning badge-pill px-25"><?= $invoice['remark']?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.col -->
                        ...
                        $test = $mysqli->select_single("SELECT test_name,description, rate FROM test WHERE id=$testID")['singledata']; ?>
                                                <tr>
                                                    ...
                                                    <td class="text-95"><?= $test['rate']?><b
                                                            style="font-size:1rem;">৳</b></td>
                        ...
                        ?>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                                            ...
                                            <div class="row my-2">
                                                ...
                                                <div class="col-5">
                                                    <span
                                                        class="text-120 text-secondary-d1"><?= $invoice['discount']?><b
                                                            style="font-size:1rem;">৳</b></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row my-2">
                                                ...
                                                <div class="col-5">
                                                    <span
                                                        class="text-110 text-secondary-d1"><?= $invoice['tax']?></span>
                                                </div>
                                            </div>
                                            <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                                ...
                                                <div class="col-5">
                                                    <span class="text-150 text-success-d3 opacity-2" id="get_total"
                                                        data-tatal="<?= $invoice['total']?>"><?= $invoice['total']?><b
                                                            style="font-size:1rem;">৳</b></span>
                                                </div>
                                            </div>
                                            <?php
                                ...
                                ?>
                                            <div class="row my-2 align-items-center bgc-primary-l3 p-2">
                                                ...
                                                <div class="col-5">
                                                    <span
                                                        class="text-150 text-success-d3 opacity-2"><?= $invoice['return']?><b
                                                            style="font-size:1rem;">৳</b></span>
                                                </div>
                                            </div>
                                            <?php } ?>
                                            ...
                                            <div class="row  align-items-center bgc-primary-l3 p-2">
                                                ...
                                                <div class="col-5">
                                                    <span class="text-150 text-success-d3 opacity-2"
                                                        style="background-color: #615f5f;color:#fff;padding:.3rem"
                                                        data-payment="<?= $invoice['payment']?>"
                                                        id="get_payment"><?= $invoice['payment']?><b
                                                            style="font-size:1rem;">৳</b></span>
                                                </div>
                                            </div>
                                            <?php
                                ...
                                ?>
                                            <div class="row align-items-center bgc-primary-l3 p-2"
                                                ...
                                                <div class="col-5">
                                                    <span class="text-150 text-success-d3 opacity-2"
                                                        id="get_due"><?= $invoice['total'] - $invoice['payment']?><b
                                                            style="font-size:1rem;">৳</b></span>
                                                </div>
                                            </div>
                                            <?php } ?>
                        ...
                        if($invoice['appointment_id'] != null && $invoice['remark'] == 'PAID'){
                            ?>
                                        <button type="button"
                                            class="btn btn-info btn-bold px-4 float-right mt-3 mt-lg-0" id="card">Get
                        ...
                        <div id="appointmentCard"
                            ...
                            <div style="justify-content:space-around;margin:1rem;border:1px dashed #ddd;padding:1rem; ">
                                <span>
                                    ...
                                    <input style="border:none;background:#ddd;padding:.4rem;border-radius:.2rem;"
