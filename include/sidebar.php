    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#nurse" aria-expanded="false" aria-controls="nurse">
                <span class="menu-title">Assistant</span>
                <i class="menu-arrow"></i>
                <i class="mdi mdi-medical-bag menu-icon"></i>
            </a>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic2">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link"
                            href="<?= $baseurl ?>/controller/department.php">Department</a></li>
                    <li class="nav-item"> <a class="nav-link"
                            href="<?= $baseurl ?>/controller/designation.php">Designation</a></li>
                    <li class="nav-item"> <a class="nav-link"
                            href="<?= $baseurl ?>/controller/room.php">Cavin/Chamber</a></li>
                </ul>
            </div>
        </li>
    </ul>
